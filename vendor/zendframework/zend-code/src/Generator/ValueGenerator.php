...
class ValueGenerator extends AbstractGenerator
{
    ...
    public function generate()
    {
        ...
        switch ($type) {
            ...
            default:
                throw new Exception\RuntimeException(sprintf('Type "%s" is unknown or cannot be used as property default value.', is_object($value) ? get_class($value) : gettype($value)));
        }
        return $output;
    }
    /**
