...
class FilterIterator extends FastPriorityQueue
{
    ...
    public function insert($value, $priority)
    {
        if (!is_callable($value)) {
            throw new Exception\InvalidArgumentException(sprintf('%s can only aggregate callables; received %s', __CLASS__, is_object($value) ? get_class($value) : gettype($value)));
        }
