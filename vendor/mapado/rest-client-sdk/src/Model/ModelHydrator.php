...
class ModelHydrator
{
     ...
     */
    public function hydrate(array $data = null, $modelName)
    {
        $mapping = $this->sdk->getMapping();
        $key = $mapping->getKeyFromModel($modelName);
     ...
     */
    public function hydrateList(array $data = null, $modelName)
    {
     ...
     */
    private function deserializeAll(array $data, $modelName)
    {
        $collectionKey = $this->sdk->getMapping()->getConfig()['collectionKey'];
        ...
        $extraProperties = array_filter($data, function ($key) use($collectionKey) {
     ...
     */
    private function deserialize(array $data = null, $modelName)
    {
        if (null === $data) {
            return null;
        }
     ...
     */
    private function guessCollectionClassname(array $data)
    {
        switch (true) {
