...
class SdkClient
{
    ...
    public function __construct(RestClient $restClient, Mapping $mapping, UnitOfWork $unitOfWork = null, Serializer $serializer = null)
    {
    ...
    public function createProxy($id)
    {
        ...
        $initializer = function (GhostObjectInterface $proxy, $method, array $parameters, &$initializer, array $properties) use($sdk, $classMetadata, $id, $proxyModelName) {
                ...
                if ($id) {
                    ...
                    if (null !== $model) {
                        ...
                        foreach ($attributeList as $attribute) {
                            $value = $this->getPropertyAccessor()->getValue($model, $attribute->getAttributeName());
        ...
        $instance = $factory->createProxy($modelName, $initializer, ['skippedProperties' => ["\0" . $proxyModelName . "\0id"]]);
