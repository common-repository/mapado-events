...
class ArrayHelper
{
     ...
     * @return mixed
     */
    public static function arrayGet(array $array, $key = null, $default = null)
    {
        if (null === $key) {
            return $array;
        }
     ...
     */
    public static function arrayHas(array $array, $key = null)
    {
    ...
    public static function arraySame(array $array1, array $array2)
    {
