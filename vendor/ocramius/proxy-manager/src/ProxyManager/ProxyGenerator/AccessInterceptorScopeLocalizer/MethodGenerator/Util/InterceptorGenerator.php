...
class InterceptorGenerator
{
     ...
     */
    public static function createInterceptedMethodBody($methodBody, MethodGenerator $method, PropertyGenerator $prefixInterceptors, PropertyGenerator $suffixInterceptors, \ReflectionMethod $originalMethod = null)
    {
