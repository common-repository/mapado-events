...
class PublicScopeSimulator
{
     ...
     */
    public static function getPublicAccessSimulationCode($operationType, $nameParameter, $valueParameter = null, PropertyGenerator $valueHolder = null, $returnPropertyName = null)
    {
     ...
     * @throws \InvalidArgumentException
     */
    private static function getOperation($operationType, $nameParameter, $valueParameter = null)
    {
