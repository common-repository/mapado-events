...
class InterceptorGenerator
{
     ...
     */
    public static function createInterceptedMethodBody($methodBody, MethodGenerator $method, PropertyGenerator $valueHolder, PropertyGenerator $prefixInterceptors, PropertyGenerator $suffixInterceptors, \ReflectionMethod $originalMethod = null)
    {
