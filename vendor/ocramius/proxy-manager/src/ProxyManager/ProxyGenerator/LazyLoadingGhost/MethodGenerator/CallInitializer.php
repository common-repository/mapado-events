...
@return mixed
DOCBLOCK;
        parent::__construct(IdentifierSuffixer::getIdentifier('callInitializer'), [new ParameterGenerator('methodName'), new ParameterGenerator('parameters', 'array')], static::FLAG_PRIVATE, null, $docBlock);
...
PHP;
    ...
    private function generatePrivatePropertiesAssignmentsCode(array $properties)
    {
        ...
        foreach ($properties as $property) {
            ...
            $code .= '    $properties[' . var_export($key, true) . '] = ' . '& $instance->' . $property->getName() . ";\n";
        }
        return $code;
    }
