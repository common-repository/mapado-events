...
class LazyLoadingValueHolderGenerator implements ProxyGeneratorInterface
{
    ...
    private function buildLazyLoadingMethodInterceptor(InitializerProperty $initializer, ValueHolderProperty $valueHolder)
    {
        return function (ReflectionMethod $method) use($initializer, $valueHolder) {
