...
PHP;
    ...
    {
        return [ScriptEvents::POST_INSTALL_CMD => 'dumpVersionsClass', ScriptEvents::POST_UPDATE_CMD => 'dumpVersionsClass'];
    }
    /**
     ...
     */
    private static function generateVersionsClass($rootPackageName, array $versions)
    {
        return sprintf(
